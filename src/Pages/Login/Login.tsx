...
function Login() {
    ...
    const handleSubmit = async(event:React.SyntheticEvent)=>{
        ...
        let response = await postAPI("api/user/loginUser",
            {
    ...
    return (
        <>
            <div className=" h-screen overflow-hidden flex items-center justify-center">
                <div className="bg-white lg:w-5/12 md:6/12  shadow-3xl">
                    ...
                    <form className="p-12 md:p-10" onSubmit={handleSubmit}>
                        ...
                        <div className="text-lg mb-6 md:mb-8">
                            ...
                            <input type="password"  name="password" id="password" className="bg-gray-200 pl-4 py-2 md:py-4 focus:outline-none w-full" placeholder="Password" />
                        </div>
                        <button className="bg-black font-medium p-2 md:p-4 text-white uppercase w-full">Login</button>
                    </form>
                </div>
            </div>
